...
public struct EZLoadingActivity {
    ...
    public struct Settings {
        public static var BackgroundColor = UIColor(red: 1, green: 1, blue: 1, alpha: 1.0)
        public static var ActivityColor = UIColor(red: 73/255, green: 125/255, blue: 64/255, alpha: 1.0)
        public static var TextColor = UIColor(red: 73/255, green: 125/255, blue: 64/255, alpha: 1.0)
